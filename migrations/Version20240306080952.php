 ...
 */
final class Version20240306080952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, is_registered TINYINT(1) NOT NULL, name VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, ext_id VARCHAR(255) DEFAULT NULL, is_blocked TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', recovery VARCHAR(255) DEFAULT NULL, role VARCHAR(255) DEFAULT NULL, password_unencrypted VARCHAR(255) DEFAULT NULL, is_allow_order TINYINT(1) DEFAULT 0 NOT NULL, is_allow_all_clients TINYINT(1) DEFAULT 0 NOT NULL, pay_code VARCHAR(255) DEFAULT NULL, pay_des VARCHAR(255) DEFAULT NULL, max_credit DOUBLE PRECISION DEFAULT NULL, max_obligo DOUBLE PRECISION DEFAULT NULL, hp VARCHAR(255) DEFAULT NULL, tax_code VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
