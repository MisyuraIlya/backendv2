 ...
 */
final class Version20240301092200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, sku VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, default_image_path VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, barcode VARCHAR(255) DEFAULT NULL, is_published TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', base_price INT DEFAULT NULL, final_price INT DEFAULT NULL, stock INT NOT NULL, pack_quantity INT DEFAULT NULL, discount INT DEFAULT NULL, orden INT NOT NULL, ext_lvl2 VARCHAR(255) DEFAULT NULL, ext_lvl3 VARCHAR(255) DEFAULT NULL, is_humane TINYINT(1) NOT NULL, is_veterinary TINYINT(1) NOT NULL, is_pharmecies TINYINT(1) NOT NULL, is_medical_center TINYINT(1) NOT NULL, is_hospital TINYINT(1) NOT NULL, is_drug_not_in_basket TINYINT(1) NOT NULL, link VARCHAR(255) DEFAULT NULL, link_title VARCHAR(255) DEFAULT NULL, inner_html LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, is_registered TINYINT(1) NOT NULL, name VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, ext_id VARCHAR(255) NOT NULL, is_blocked TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', recovery VARCHAR(255) DEFAULT NULL, role VARCHAR(255) DEFAULT NULL, password_unencrypted VARCHAR(255) DEFAULT NULL, is_allow_order TINYINT(1) NOT NULL, is_allow_all_clients TINYINT(1) NOT NULL, pay_code VARCHAR(255) DEFAULT NULL, pay_des VARCHAR(255) DEFAULT NULL, max_credit DOUBLE PRECISION DEFAULT NULL, max_obligo DOUBLE PRECISION DEFAULT NULL, hp VARCHAR(255) DEFAULT NULL, tax_code VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
